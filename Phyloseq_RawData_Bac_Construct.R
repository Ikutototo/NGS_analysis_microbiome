...
# setwd("~/Library/CloudStorage/GoogleDrive-saito2022@patholab-meiji.jp/マイドライブ/芝草/NGS_consignment/Novogene/Data/250331")
setwd("~/Library/CloudStorage/GoogleDrive-saito2022@patholab-meiji.jp/My Drive/芝草/NGS_consignment/Novogene/Data/250331")


# 必要なPackageを個別に読み込んだほうが良い 
# lib <- c("dada2", "ggplot2","Biostrings", "phyloseq", "ShortRead", "crayon",
#          "dplyr", "DESeq2", "apeglm", "pheatmap", "RColorBrewer", "svglite")
# for (i in lib) {
#     print(i)
...
load("~/Library/CloudStorage/GoogleDrive-saito2022@patholab-meiji.jp/My Drive/芝草/NGS_consignment/Novogene/Data/250331/RData/Physeq.RData")
...
# load("~/Library/CloudStorage/GoogleDrive-saito2022@patholab-meiji.jp/My Drive/芝草/NGS_consignment/Novogene/Data/250331/RData/PlotQC/TaxaData.RData")
# load("~/Library/CloudStorage/GoogleDrive-saito2022@patholab-meiji.jp/My Drive/芝草/NGS_consignment/Novogene/Data/250331/RData/PlotQC/MergeData.RData")
load("~/Library/CloudStorage/GoogleDrive-saito2022@patholab-meiji.jp/My Drive/芝草/NGS_consignment/Novogene/Data/250331/RData/SaveObjects/fitGTR_done.RData")
