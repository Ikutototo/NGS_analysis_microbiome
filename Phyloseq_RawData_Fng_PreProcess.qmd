...
# pdfで出力する場合、htmlのYAML optionを消去すること
html:
    grid: 
      body-width: 1600px
    code-fold: FALSE
...
[**有意に存在量が異なる分類群(ASVs)の探索**]{.mark-red}
...
knitr::opts_knit$set(
    root.dir = "/Users/ikutosaito/Library/CloudStorage/GoogleDrive-saito2022@patholab-meiji.jp/My Drive/芝草/NGS_consignment/Novogene/Data")
...
# 不要なpakageは、極力読み込まないこと！！
# lib <- c("ggplot2", "Biostrings", "phyloseq", "dplyr", "DESeq2", "scales")
# for (i in lib) {
#     print(i)
